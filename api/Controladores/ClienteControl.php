      ...
      $respuesta = json_encode(array('cliente' => null, "std" => 0, "msg" => "Email o contraseña no validos."));
        ...
        if($cliente->estado == "ACTIVO"){
            ...
            if($cliente->estado == "INACTIVO"){
                $respuesta = json_encode(array('cliente' => null, "std" => 2, "msg" => "Debe activar su cuenta ingresando a la dirección enviada a su correo"));
            }else{
                $respuesta = json_encode(array('cliente' => null, "std" => 3, "msg" => "Su cuenta ha sido desactivada por infringir las normas del sitio"));
            }
        }
    }
    $response->getBody()->write($respuesta);
              ...
              $mensaje = ""
                      . "<html>
                          ...
                          <img style='height:40px;' src='http://turnomovil.com/images/turnomovil.png' alt=''/>
                            ...
                            <h4><a href='http://turnomovil.com/sesion.html#/cambiarclavecliente/$cliente->id/$para' target='_blank'>Click Aqui, para cambiar la Contraseña</a></h4>
                            <h4>Atentamente</h4>
                            <h4>Turnomovil.com</h4>
                          </body>
                          </html>";
