  ...
  function sesionlogin(Request $request, Response $response){
    ...
    function enviaremail(Request $request, Response $response){
      try {
          ...
          $cliente = Empleado::select('*')
                      ->where('identificacion','=',$id)
                      ->first();

          if($cliente == null){
              $respuesta = json_encode(array("msg" => "La identificación ingresada no esta registrado en el sistema", "std" => 0));
          }else{
              ...
              $mensaje = ""
                      . "<html>
                          ...
                          <img style='height:40px;' src='http://turnomovil.com/images/turnomovil.png' alt=''/>
                            ...
                            <h4><a href='http://turnomovil.com/sesion.html#/cambiarclave/$cliente->id/$para' target='_blank'>Click Aqui, para cambiar la Contraseña</a></h4>
                            <h4>Atentamente</h4>
